...
PublicServiceProvide.prototype.render_point_layer = function(){
    ...
    round_point_layer.setData(endowment_facilities_point_data, {
        lnglat: 'lnglat'
    });
...
PublicServiceProvide.prototype.load_dom = function(){
	var public_service_dom_str = '<div class="chart_view" style="width: 100%; height: 60%;">'+
		...
		'<p style="padding-left:21%;box-sizing: border-box;color:#fff;font-size:18px;">街道养老设施覆盖率：<span id="total_coverage" style="font-size:36px;color:#F7C370;">0%</span></p>'+
		'</div>'+
		'<div id="fraction_coverage_content" style="width: 100%; height: 87%;"></div></div>'+
		'<div class="chart_view" style="width: 100%; height: 40%;">'+
		'<p style="padding:10px 0 10px 20px;font-size:14px;color:#fff;font-weight:700;">养老设施看板</p>'+
