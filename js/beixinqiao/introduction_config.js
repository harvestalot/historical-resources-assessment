//各个社区名称
var community_name = ["北官厅", "北新仓", "藏经馆", "草园", "海运仓", "九道湾",
	"门楼", "民安", "前永康", "青龙", "十三条", "小菊"];
...
var brief_introduction = {
	title:"平台简介",
	img_url:[],
	content: "北新桥街道位于东城区东北部，东起东二环路，西至崇雍大街，南起平安大街，北至北二环路。辖区面积 2.62 平方公里，有 5 条主要大街，79 条胡同。现有户籍人口 28751 户 77593 人，常住人口 31293 户 86860 人，其中流动人口21469 人。辖 12 个社区，其中楼房社区 4 个、平房社区 8 个。有 7 处国家市区级文保单位（国家级的雍和宫，市级的柏林寺、通教寺、北新仓、四合院，区 级的当铺旧址、慧照寺修建碑）、一条国际知名的餐饮特色街——簋街。辖区内现有 4900 平方米自管绿地及 4349 株自管树木（其中包括 44 株古树）。北护城河从雍和宫至东直门流过，全长 1.57 公里；辖区东北处有南馆公园一处，水域面积约 5000 平方米。*平台主要针对人口、用地、公共空间资源、基础公服设施、文化资源、街区活力、产业发展、业态培育等多个维度进行评估。"
}
//规划和目标
var planning_target = {
    title:"规划目标",
...
// echarts颜色配置
var echarts_color = ["#d66349",'#41FC86',"#f0993c",'#a57ec0',"#579dcb","#5cba89","#7758b0"];
...
var rader_color = [
	...
	},
	{
        ...
        areaStyle: {
            normal: {
                color: "rgba(65,252,134, 0.4)"
            }
        },
        itemStyle:{
            color:'rgba(65,252,134, 1)',
            borderColor:'rgba(65,252,134, 0.3)',
            borderWidth:5,
        },
        lineStyle: {
            normal: {
